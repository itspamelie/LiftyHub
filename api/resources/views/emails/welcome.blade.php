...
<head>
  ...
  <title>Bienvenido a LiftyHub</title>
  <style>
    ...
    [data-ogsc] .e-sep    { background-color:#2a2a50 !important; }
    ...
    [data-ogsc] .e-card-text { color:#ccccee !important; }
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0d0d1f" style="max-width:540px;background-color:#0d0d1f;">
        ...
        <tr>
          <td class="e-header" bgcolor="#1a1a35" style="background-color:#1a1a35;border-radius:14px 14px 0 0;padding:28px 36px 22px;" align="center">
            ...
            <p class="e-sub" style="margin:10px 0 0;font-size:10px;color:#4a4a70;letter-spacing:3px;text-transform:uppercase;font-family:Arial,Helvetica,sans-serif;">Tu plataforma de fitness</p>
          </td>
        </tr>
        ...
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:36px 36px 24px;" align="center">
            <h1 class="e-h1" style="margin:0 0 10px;font-size:24px;font-weight:800;color:#e8e8ff;font-family:Arial,Helvetica,sans-serif;">Bienvenido, {{ $userName }}</h1>
            <p class="e-p" style="margin:0;font-size:14px;color:#7777aa;line-height:22px;font-family:Arial,Helvetica,sans-serif;">Tu cuenta ha sido creada exitosamente.<br>Estas listo para comenzar tu transformacion.</p>
          </td>
        </tr>

        <!-- SEPARADOR -->
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:0 36px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="e-sep" bgcolor="#2a2a50" style="background-color:#2a2a50;height:1px;font-size:1px;line-height:1px;">&nbsp;</td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <!-- LABEL -->
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:24px 36px 12px;">
            <p class="e-accent" style="margin:0;font-size:10px;font-weight:700;color:#3B82F6;text-transform:uppercase;letter-spacing:2.5px;font-family:Arial,Helvetica,sans-serif;">Con tu cuenta puedes</p>
          </td>
        </tr>

        <!-- BENEFICIO 1 -->
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:0 36px 5px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="e-card" bgcolor="#0d0d22" style="background-color:#0d0d22;border-left:3px solid #3B82F6;border-radius:0 6px 6px 0;padding:11px 14px;">
                  <span class="e-card-text" style="font-size:13px;color:#ccccee;font-family:Arial,Helvetica,sans-serif;">Crear y personalizar tus rutinas de entrenamiento</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:0 36px 5px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="e-card" bgcolor="#0d0d22" style="background-color:#0d0d22;border-left:3px solid #3B82F6;border-radius:0 6px 6px 0;padding:11px 14px;">
                  <span class="e-card-text" style="font-size:13px;color:#ccccee;font-family:Arial,Helvetica,sans-serif;">Ver tus estadisticas y registrar progreso</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:0 36px 5px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="e-card" bgcolor="#0d0d22" style="background-color:#0d0d22;border-left:3px solid #3B82F6;border-radius:0 6px 6px 0;padding:11px 14px;">
                  <span class="e-card-text" style="font-size:13px;color:#ccccee;font-family:Arial,Helvetica,sans-serif;">Compartir rutinas por QR con tus amigos</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:0 36px 5px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="e-card" bgcolor="#0d0d22" style="background-color:#0d0d22;border-left:3px solid #3B82F6;border-radius:0 6px 6px 0;padding:11px 14px;">
                  <span class="e-card-text" style="font-size:13px;color:#ccccee;font-family:Arial,Helvetica,sans-serif;">Mantener tu racha y superar retos personales</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <!-- CTA -->
        <tr>
          <td class="e-body" bgcolor="#161630" style="background-color:#161630;padding:28px 36px 36px;" align="center">
