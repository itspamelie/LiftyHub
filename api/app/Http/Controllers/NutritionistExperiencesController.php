...
use App\Models\NutritionistExperience;

class NutritionistExperiencesController extends Controller
{
      public function index()
    {
         $data = NutritionistExperience::with('nutritionist')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = NutritionistExperience::create($validated);
          return response()->json([
            "status"=>"ok",
    ...
    {
         $data = NutritionistExperience::find($id);
        if($data){
            return response()->json([
            "status"=>"ok",
    ...
    public function update(Request $request, string $id)
    {
        ...
        //metodo si los campos se llaman igual que en la base de datos
        $data = NutritionistExperience::findOrFail($id);
