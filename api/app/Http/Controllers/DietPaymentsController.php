...
use App\Models\DietPayment;

class DietPaymentsController extends Controller
{
            public function index()
    {
         $data = DietPayment::with('request')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = DietPayment::create($validated);
          return response()->json([
            "status"=>"ok",
    ...
    public function update(Request $request, string $id)
    {
        ...
        //metodo si los campos se llaman igual que en la base de datos
        $data = DietPayment::findOrFail($id);
