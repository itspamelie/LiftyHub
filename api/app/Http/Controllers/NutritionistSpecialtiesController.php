...
use App\Models\NutritionistSpecialty;

class NutritionistSpecialtiesController extends Controller
{
             public function index()
    {
         $data = NutritionistSpecialty::with('nutritionist','specialty')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = NutritionistSpecialty::create($validated);
          return response()->json([
            "status"=>"ok",
    ...
    {
         $data = NutritionistSpecialty::find($id);
        if($data){
            return response()->json([
            "status"=>"ok",
    ...
    public function update(Request $request, string $id)
    {
        ...
        //metodo si los campos se llaman igual que en la base de datos
        $data = NutritionistSpecialty::findOrFail($id);
