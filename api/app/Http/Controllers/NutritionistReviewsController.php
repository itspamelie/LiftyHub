...
class NutritionistReviewsController extends Controller
{
    public function index()
    {
         $data = NutritionistReview::with('nutritionist','user')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = NutritionistReview::create($validated);
          return response()->json([
            "status"=>"ok",
    ...
    {
         $data = NutritionistReview::find($id);
        if($data){
            return response()->json([
            "status"=>"ok",
    ...
    public function update(Request $request, string $id)
    {
        ...
        //metodo si los campos se llaman igual que en la base de datos
        $data = NutritionistReview::findOrFail($id);
