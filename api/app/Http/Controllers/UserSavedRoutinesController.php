...
use App\Models\UserSavedRoutine;


class UserSavedRoutinesController extends Controller
{
         public function index()
    {
         $data = UserSavedRoutine::with('user','routine')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = UserSavedRoutine::create($validated);
          return response()->json([
            "status"=>"ok",
    ...
    public function update(Request $request, string $id)
    {
        ...
        //metodo si los campos se llaman igual que en la base de datos
        $data = UserSavedRoutine::findOrFail($id);
