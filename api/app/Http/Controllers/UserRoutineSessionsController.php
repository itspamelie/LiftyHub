...
class UserRoutineSessionsController extends Controller
{
    public function index()
    {
         $data = UserRoutineSession::with('user','routine','userRoutine')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = UserRoutineSession::create($validated);
          return response()->json([
            "status"=>"ok",
    ...
    {
         $data = UserRoutineSession::find($id);
        if($data){
            return response()->json([
            "status"=>"ok",
